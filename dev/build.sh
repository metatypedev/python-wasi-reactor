...
PYO3_NO_PYTHON=1 cargo build --target=wasm32-wasi --features "wasm" -p python-wasi-reactor --release
cp target/wasm32-wasi/release/python-wasi-reactor.wasm \
    build/python-wasi-reactor.wasm
